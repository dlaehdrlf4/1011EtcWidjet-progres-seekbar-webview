...
public class WebViewPrec extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_web_view_prec);
            ...
            public void onClick(View v) {
                switch (v.getId()){
                    ...
                    case R.id.url:
                        ...
                        /*Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(addr.getText().toString()));
        ...
        //버튼에 리스너 연결
        local.setOnClickListener(handler);
        url.setOnClickListener(handler);
